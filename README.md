...
<p>
  ...
  <a href="https://swift.org">
    <img src="https://img.shields.io/badge/Swift-5.3.1-F05138?logo=swift&logoColor=white" alt="Swift 5.3.1" />
  </a>
...
- `"5"` will resolve to latest minor and patch version (aka `5.3.1`)

### Caveats

YAML interprets eg. `5.0` as a float, this action will then interpret that as `5` which will result in eg. Swift 5.3.1 being resolved. Quote your inputs! Thus:
